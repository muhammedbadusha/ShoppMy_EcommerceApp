...
class ApiClient {
  ...
  static final String loginbasePath = 'http://192.168.18.39:8000';
...
String signupurl=basePath;
    ...
    switch (method) {
      case "POST":
        response = await post(Uri.parse(basePath), headers: {'content-Type': 'application/json',}, body: body);
        break;
      case "PUT":
