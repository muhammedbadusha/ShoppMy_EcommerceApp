...
BlocProvider.of<AllProductsblocBloc>(context).add(getAllProductsEvent());
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: BlocBuilder<AllProductsblocBloc,AllProductsblocState>(builder: (context, state) {
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text('ADD DELIVERY LOCATION',style:GoogleFonts.openSans(fontWeight: FontWeight.w600),),
                                              IconButton(onPressed: (){Navigator.of(context).pop();}, icon: const Icon(Icons.clear,color: Colors.grey,))
                                            ],
                                          ),
                                        ),
                                      ),
                                      Divider(indent: 2,endIndent: 2,color: Colors.grey,height: 4,),
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration:  InputDecoration(
                                              ...
                                              suffix: TextButton(onPressed: (){}, child:Text('SUBMIT',style:TextStyle(color: Color(0xFFCB7C8E) ,))),
                                              hintText:
        ...
        if(state is AllProductsblocError){
          return Center (child:  Text("your code is wrong"),);
        }
